...
foreach ($blogs as $blog): 
    ...
    // شمارش کامنت‌ها برای هر مقاله
    $rowcoment = $conn->prepare("SELECT COUNT(*) FROM coment WHERE post = ?");
    $rowcoment->bindValue(1, $blog['id'], PDO::PARAM_INT);
    $rowcoment->execute();
    $count = $rowcoment->fetchColumn(); // استفاده از fetchColumn برای شمارش کامنت‌ها
    
?>
        <div class="blog">
            <img src="../uploads/<?= htmlspecialchars($blog['image']) ?>" alt="تصویر مقاله" class="article-image">
            ...
            <div class="iconsSec">
                <div class="icons">
                    ...
                    <div class="comment icon">
                        <p><?= $count ?></p> <!-- نمایش تعداد کامنت‌ها -->
